...
<head>
  ...
  <title>PT WARNA EMAS INDONESIA</title>
                  ...
                  @csrf
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" name="username" class="form-control @error('username') is invalid @enderror" id="username" required autofocus value="{{('') }}">
